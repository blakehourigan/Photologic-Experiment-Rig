...
class MainGUI:
    ...
    def lower_control_buttons(self):
        ...
        self.open_all_valves_button_frame ,_ = self.create_button(self.lower_control_buttons_frame, "Open All Valves", print('test'), "grey", 0,1)
        ...
        self.data_window_button_frame = self.create_button(self.lower_control_buttons_frame, "SD1 V SD2 Data", self.controller.data_window.show_window, "grey", 1, 2)
