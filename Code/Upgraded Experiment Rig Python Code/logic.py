...
class ExperimentLogic:
    ...
    def read_licks(self, i):
        ...
        if(available_data):
            ...
            if "Stimulus One Lick" in data:
                ...
                self.controller.data_mgr.licks_dataframe.loc[self.controller.data_mgr.total_licks, 'Trial Number'] = self.controller.data_mgr.current_trial_number
        ...
        self.update_licks_id = self.controller.main_gui.root.after(100, lambda: self.read_licks(i))
    ...
    def check_licks(self, iteration):
        ...
        if (self.side_one_licks >= 3 or self.side_two_licks >= 3) and self.controller.state == 'TTC':
            self.controller.data_mgr.stimuli_dataframe.loc[self.controller.data_mgr.current_trial_number - 1,'TTC Actual'] = \
