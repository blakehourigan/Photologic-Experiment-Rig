...
class MainGUI:
    ...
    def display_user_entry_widgets(self) -> None:
        ...
        self.interval1_entry = tk.Entry(self.interval1_frame, textvariable=self.controller.data_mgr.interval_vars['ITI_var'], font=("Helvetica", 24))
        ...
        self.interval2_entry = tk.Entry(self.interval2_frame, textvariable=self.controller.data_mgr.interval_vars['TTC_var'], font=("Helvetica", 24))
        ...
        self.interval3_entry = tk.Entry(self.interval3_frame, textvariable=self.controller.data_mgr.interval_vars['sample_var'], font=("Helvetica", 24))
        ...
        self.num_trial_blocks_entry = tk.Entry(self.num_trial_blocks_frame, textvariable=self.controller.data_mgr.num_trial_blocks, font=("Helvetica", 24))
        ...
        self.num_stimuli_entry = tk.Entry(self.num_stimuli_frame, textvariable=self.controller.data_mgr.num_stimuli, font=("Helvetica", 24))
        ...
        self.interval1Rand_entry = tk.Entry(self.interval1Rand_frame, textvariable=self.controller.data_mgr.interval_vars['ITI_random_entry'], font=("Helvetica", 24))
        ...
        self.interval2Rand_entry = tk.Entry(self.interval2Rand_frame, textvariable=self.controller.data_mgr.interval_vars['TTC_random_entry'], font=("Helvetica", 24))
        ...
        self.interval3Rand_entry = tk.Entry(self.interval3Rand_frame, textvariable=self.controller.data_mgr.interval_vars['sample_random_entry'], font=("Helvetica", 24))
    ...
    def display_buttons(self) -> None:
        ...
        self.exp_ctrl_button_frame.grid(row=9, column=0, pady=10, padx=10, sticky='nsew', columnspan=1)
        self.experiment_control_button = tk.Button(self.exp_ctrl_button_frame, text="Experiment CTL", command=lambda: self.controller.experiment_ctl_wind.show_window(self.root), bg="grey", font=("Helvetica", 24))
        ...
        self.lick_window_button_frame.grid_propagate(False)  # Disables resizing of frame
        self.lick_window_button_frame.grid(row=9, column=1, pady=10, padx=10, sticky='nsew', columnspan=1)
        self.lick_window_button = tk.Button(self.lick_window_button_frame, text="Lick Data", command=self.controller.licks_window.show_window, bg="grey", font=("Helvetica", 24))
        ...
        self.data_window_button_frame.grid_propagate(False)  # Disables resizing of frame
        self.data_window_button_frame.grid(row=9, column=2, pady=10, padx=10, sticky='nsew')
        self.data_window_button = tk.Button(self.data_window_button_frame, text="View Data", command=self.controller.data_window.show_window, bg="grey", font=("Helvetica", 24))
